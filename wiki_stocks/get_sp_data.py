...
# https://finance.yahoo.com/quote/FAF/analysis?p=FAF
        ...
        for table in tables:
            ...
            for tr in trs:
                try:
                    ...
                    print(stock["ticker"])
            session.commit()
        yahoo_analysis = requests.get(
            f'https://finance.yahoo.com/quote/{stock["ticker"]}/analysis', headers={'User-Agent': 'Custom'})
        # print(yahoo_analysis)
        soup_analysis = BeautifulSoup(yahoo_analysis.content, "html.parser")
        tables_analysis = soup_analysis.find_all("table")
